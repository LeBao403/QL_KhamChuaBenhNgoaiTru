...
('NV016', N'Vũ Thị Ngọc', '1991-12-04', N'Nữ', '0916123466', 'ngoc.vu@vnvc.vn', N'Hải Phòng', 6, 1, 16, 11, 19, NULL),
('NV017', N'Đinh Văn Phát', '1985-10-16', N'Nam', '0917123467', 'phat.dinh@vnvc.vn', N'Nghệ An', 6, 1, 17, 10, 20, NULL),
('NV018', N'Nguyễn Thị Phương', '1992-04-07', N'Nữ', '0918123468', 'phuong.nguyen@vnvc.vn', N'Bình Dương', 6, 1, 18, 10, 16, NULL),
('NV019', N'Phạm Văn Quân', '1989-07-28', N'Nam', '0919123469', 'quan.pham@vnvc.vn', N'Nha Trang', 6, 1, 19, 10, 21, NULL),
('NV020', N'Trương Thị Quỳnh', '1996-11-11', N'Nữ', '0920123470', 'quynh.truong@vnvc.vn', N'Huế', 6, 1, 20, 10, 16, NULL),

-- Nhóm Dược sĩ
('NV021', N'Đỗ Bảo Trâm', '1990-07-21', N'Nữ', '0903200111', 'tram.db@vnvc.vn', N'39 Nguyễn Huệ, TP.HCM', 7, 1, 21, 12, 18, NULL), 
('NV022', N'Võ Văn Quân', '1993-01-12', N'Nam', '0903222333', 'quan.vv@vnvc.vn', N'15 Lê Lợi, TP.HCM', 7, 1, 22, 11, 19, NULL), 
...
('NV025', N'Hoàng Mỹ Dung', '1994-03-03', N'Nữ', '0903111000', 'dung.hm@vnvc.vn', N'25 CMT8, TP.HCM', 12, 1, 25, 12, 22, NULL), 
('NV026', N'Đinh Quốc Thịnh', '1987-12-17', N'Nam', '0903444555', 'thinh.dq@vnvc.vn', N'27 Lê Quang Định, TP.HCM', 12, 1, 26, 12, 23, NULL), 
...
-- Nhân Viên Kho
('NV045', N'Trần Quốc Việt', '1993-09-30', N'Nam', '0903222555', 'viet.tq@vnvc.vn', N'110 Nguyễn Văn Linh, Đà Nẵng', 13, 1, null, null, NULL, NULL);
GO
...
UPDATE NHANVIEN SET MaTK = 45 WHERE MaNV = 'NV045';
...
-- 1. THÊM TÀI KHOẢN CHO KỸ THUẬT VIÊN CẬN LÂM SÀNG
INSERT INTO TAIKHOAN (Username, PasswordHash, IsActive)
VALUES 
('nghiem.nv', '123456', 1), -- TK cho Phòng Xét nghiệm
('am.tts', '123456', 1),    -- TK cho Phòng Siêu âm
('quang.l', '123456', 1),    -- TK cho Phòng X-Quang
('soi.pn', '123456', 1);    -- TK cho Phòng Nội soi
GO

-- 2. THÊM NHÂN VIÊN VÀ GÁN THẲNG VÀO PHÒNG
-- KTV Xét nghiệm -> Khoa 11, Phòng 19
INSERT INTO NHANVIEN (MaNV, HoTen, GioiTinh, SDT, Email, MaChucVu, MaKhoa, MaPhong, MaTK, TrangThai)
VALUES ('NV046', N'Nguyễn Văn Nghiệm', N'Nam', '0988000046', 'nghiem.nv@vnvc.vn', 6, 11, 19, (SELECT MaTK FROM TAIKHOAN WHERE Username = 'nghiem.nv'), 1);

-- KTV Siêu âm -> Khoa 10, Phòng 20
INSERT INTO NHANVIEN (MaNV, HoTen, GioiTinh, SDT, Email, MaChucVu, MaKhoa, MaPhong, MaTK, TrangThai)
VALUES ('NV047', N'Trần Thị Siêu Âm', N'Nữ', '0988000047', 'am.tts@vnvc.vn', 6, 10, 20, (SELECT MaTK FROM TAIKHOAN WHERE Username = 'am.tts'), 1);

-- KTV X-Quang -> Khoa 10, Phòng 21
INSERT INTO NHANVIEN (MaNV, HoTen, GioiTinh, SDT, Email, MaChucVu, MaKhoa, MaPhong, MaTK, TrangThai)
VALUES ('NV048', N'Lê Quang', N'Nam', '0988000048', 'quang.l@vnvc.vn', 6, 10, 21, (SELECT MaTK FROM TAIKHOAN WHERE Username = 'quang.l'), 1);

-- KTV Nội soi -> Khoa 10, Phòng 16
INSERT INTO NHANVIEN (MaNV, HoTen, GioiTinh, SDT, Email, MaChucVu, MaKhoa, MaPhong, MaTK, TrangThai)
VALUES ('NV049', N'Phạm Nội Soi', N'Nam', '0988000049', 'soi.pn@vnvc.vn', 6, 10, 16, (SELECT MaTK FROM TAIKHOAN WHERE Username = 'soi.pn'), 1);
GO
...
FROM (
    SELECT 
        ...
        ROW_NUMBER() OVER (PARTITION BY nv.MaPhong ORDER BY nv.MaNV) AS rn
    FROM NHANVIEN nv
